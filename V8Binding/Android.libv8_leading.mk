...
# Android.v8_leading_common.mk defines common V8_LOCAL_SRC_FILES
# and V8_LOCAL_JS_LIBRARY_FILES
V8_LOCAL_SRC_FILES :=
V8_LOCAL_JS_LIBRARY_FILES :=
include $(LOCAL_PATH)/Android.v8_leading_common.mk
...
LOCAL_SRC_FILES := $(addprefix v8_leading/, $(V8_LOCAL_SRC_FILES))

LOCAL_JS_LIBRARY_FILES := $(addprefix $(LOCAL_PATH)/v8_leading/, $(V8_LOCAL_JS_LIBRARY_FILES))
...
$(JS2C_PY): $(intermediates)/%.py : $(LOCAL_PATH)/v8_leading/tools/%.py | $(ACP)
	@echo "Copying $@"
	$(copy-file-to-target)
...
LOCAL_SRC_FILES += \
  v8_leading/src/snapshot-empty.cc
endif
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/v8_leading/src
